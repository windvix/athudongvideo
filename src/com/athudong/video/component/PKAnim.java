...
public class PKAnim {
	...
	public PKAnim(MainActivity act) {
		this.act = act;
	...
	private void mTop2(){
		...
		path.moveTo(w1, (topLayoutHeight));
		path.lineTo(w1, h1);
		path.lineTo(w2, 0);
		path.lineTo(0, 0);
		final ObjectAnimator anim = ObjectAnimator.ofObject(PKAnim.this, "topLoc2", new PathEvaluator(), path.getPoints().toArray());
		act.findViewById(R.id.realTopBtn02).setVisibility(View.VISIBLE);
		startAnim(anim);
	...
	private void mTop3(){
		...
		path.lineTo(w1, h1);
		path.lineTo(0, 0);
		final ObjectAnimator anim = ObjectAnimator.ofObject(PKAnim.this, "topLoc3", new PathEvaluator(), path.getPoints().toArray());
		act.findViewById(R.id.realTopBtn03).setVisibility(View.VISIBLE);
		startAnim(anim);
	}
	...
	private void mTop4(){
		...
		AnimatorPath path = new AnimatorPath();
		path.moveTo(0, realTopBtnHeight);
		path.lineTo(0, 0);
		final ObjectAnimator anim = ObjectAnimator.ofObject(PKAnim.this, "topLoc4", new PathEvaluator(), path.getPoints().toArray());
		act.findViewById(R.id.realTopBtn04).setVisibility(View.VISIBLE);
		startAnim(anim);
	}
	...
	private void mTop1(){
		...
		path.moveTo(w1, realTopBtnHeight);
		path.lineTo(w1, 0);
		path.lineTo(w2, -h1);
		path.lineTo(w3, -h1);
		path.lineTo(0, 0);
		final ObjectAnimator anim = ObjectAnimator.ofObject(PKAnim.this, "topLoc1", new PathEvaluator(), path.getPoints().toArray());
		act.findViewById(R.id.realTopBtn01).setVisibility(View.VISIBLE);
		startAnim(anim);
	...
	private void bottom1(){
		...
		AnimatorPath path = new AnimatorPath();
		path.moveTo(0, -btnWidth);
		path.lineTo(0, 0);
		final ObjectAnimator anim = ObjectAnimator.ofObject(PKAnim.this, "bottomLoc1", new PathEvaluator(), path.getPoints().toArray());
		act.findViewById(R.id.realBottomBtn01).setVisibility(View.VISIBLE);
		startAnim(anim);
	}
	private void bottom2(){
		...
		AnimatorPath path = new AnimatorPath();
		path.moveTo(-w1, -bottomLayoutHeight);
		path.lineTo(-w1, -h1);
		path.lineTo(0, 0);
		final ObjectAnimator anim = ObjectAnimator.ofObject(PKAnim.this, "bottomLoc2", new PathEvaluator(), path.getPoints().toArray());
		act.findViewById(R.id.realBottomBtn02).setVisibility(View.VISIBLE);
		startAnim(anim);
	...
	private void bottom3(){
		...
		path.lineTo(-w2, 0);
		path.lineTo(0, 0);
		final ObjectAnimator anim = ObjectAnimator.ofObject(PKAnim.this, "bottomLoc3", new PathEvaluator(), path.getPoints().toArray());
		act.findViewById(R.id.realBottomBtn03).setVisibility(View.VISIBLE);
		startAnim(anim);
	}
	private void bottom4(){
		...
		path.lineTo(-w3, h);
		path.lineTo(0, 0);
		final ObjectAnimator anim = ObjectAnimator.ofObject(PKAnim.this, "bottomLoc4", new PathEvaluator(), path.getPoints().toArray());
		act.findViewById(R.id.realBottomBtn04).setVisibility(View.VISIBLE);
		startAnim(anim);
	}
